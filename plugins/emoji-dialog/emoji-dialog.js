...
(function () {
    ...
    var factory = function (exports) {
        ...
        exports.fn.emojiDialog = function () {
            ...
            //
            //debugger;
            var category = ["Github emoji", "Twemoji", "Font awesome", "Editor-logo", "itemDoc-emoji"];
            ...
            var emojiCategories = ["github-emoji", "twemoji", "font-awesome", "editormd-logo", "itemdoc-emoji"];
            ...
            var drawTable = function () {
                ...
                var pagination = function (data, type) {
                    var rowNumber = 20;// (type === "editormd-logo") ? "5" : 20;
                    ...
                    for (var i = 0; i < pageTotal; i++) {
                        ...
                        for (var x = 0; x < rowNumber; x++) {
                            ...
                            if (typeof emoji !== "undefined" && emoji !== "") {
                                var img = "", icon = "";
                                // "github-emoji"
                                if (type === emojiCategories[0]) {
                                    var src = emoji;
                                    /// TODO  特殊处理的图片,建议更新json 文件，对配置文件修改
                                    if ((src === "+1") || (src === "black_large_square") || (src === "moon")) {
                                        //debugger;
                                        //src = (emoji === "+1") ? "plus1" : emoji; 
                                ...
                                // "twemoji"
                                else if (type === emojiCategories[1]) {
                                ...
                                // "font-awesome"
                                else if (type === emojiCategories[2]) {
                                ...
                                //"editormd-logo"
                                else if (type === emojiCategories[3]) {
                                ...
                                //todo 新增 itemdoc-emoji
                                else if (type === emojiCategories[4]) {

                                    var itemdocSrc = exports.itemdoc.path + emoji + exports.itemdoc.ext;
                                    img = "<img src=\"" + itemdocSrc + "\" width=\"24\" title=\"itemdoc-" + emoji
                                        + "\" alt=\"itemdoc-" + emoji + "\" class=\"emoji itemdoc\" />";
                                    row += "<a href=\"javascript:;\" value=\":itemdoc-" + emoji + ":\" title=\":itemdoc-" + emoji + ":\" class=\"" + classPrefix + "emoji-btn\">" + img + "</a>";
                                }
